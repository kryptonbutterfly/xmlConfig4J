...
public final class IntObjAdapter implements TypeAdapter<Integer>
{
	...
	@Override
	public void write(CommentWriter cw, XmlWriter writer, Element elem, Integer value)
	{
		if (value == null)
	...
	@Override
	public Integer read(CommentReader cr, XmlReader reader, Node node, Class<?> classOfT)
	{
